        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between py-4">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg flex-shrink-0" style={{ background: "linear-gradient(135deg, #2563EB, #06B6D4)" }} />
              <span className="font-black text-lg tracking-tight text-[#0A0E1A] uppercase">
                Actionable<span className="text-transparent bg-clip-text" style={{ backgroundImage: "linear-gradient(90deg,#2563EB,#06B6D4)" }}> Insight</span>
              </span>
            </div>
            <div className="flex items-center gap-3">
              <a href="#" className="text-sm font-semibold text-gray-500 hover:text-[#0A0E1A] px-3 py-2 transition-colors hidden md:block">
                Sign In
              </a>
              <button
