            ...
            <AnimatedSection delay={0.1} className="flex-1 w-full min-w-0">
              <div className="relative w-full flex flex-col items-center justify-center min-h-[600px]">
                ...
                <div className="relative w-[380px] h-[300px] flex items-center justify-center z-10">
                  ...
                  {/* Back card */}
                  <div
                    className="absolute w-[370px] rounded-2xl bg-white flex flex-col"
                    style={{ transform: "rotate(-8deg) translate(-18px, 18px) scale(0.91)", opacity: 0.5, zIndex: 1, boxShadow: "0 16px 50px rgba(0,0,0,0.10)" }}
                  >
                    <div className="h-[52px] rounded-t-2xl flex justify-between items-center px-4" style={{ background: "linear-gradient(90deg,#7C3AED,#2563EB)" }}>
                    ...
                    <div className="p-4">
                      ...
                      <div className="text-gray-400 text-xs mb-3">LSU Health</div>
                      <div className="flex gap-2">
                        {["$420K", "3 days", "Oncology"].map((t) => (
                          <div key={t} className="bg-gray-50 border border-gray-100 rounded-lg px-2.5 py-1 text-xs font-semibold text-gray-600">{t}</div>
                        ))}
                      </div>
                    </div>
                  </div>
                  ...
                  <div
                    className="absolute w-[370px] rounded-2xl bg-white flex flex-col"
                    style={{ transform: "rotate(-3deg) translate(-7px, 9px) scale(0.96)", opacity: 0.82, zIndex: 2, boxShadow: "0 18px 55px rgba(0,0,0,0.11)" }}
                  >
                    <div className="h-[52px] rounded-t-2xl flex justify-between items-center px-4" style={{ background: "linear-gradient(90deg,#7C3AED,#2563EB)" }}>
                      <div className="flex items-center gap-2">
                    ...
                    <div className="p-4">
                      ...
                      <div className="text-gray-400 text-xs mb-3">City of Hope</div>
                      <div className="flex gap-2">
                        {["$190K", "12 days", "Neurology"].map((t) => (
                          <div key={t} className="bg-gray-50 border border-gray-100 rounded-lg px-2.5 py-1 text-xs font-semibold text-gray-600">{t}</div>
                        ))}
                      </div>
                    </div>
                  ...
                  <div
                    className="absolute w-[370px] rounded-2xl bg-white flex flex-col"
                    style={{ zIndex: 10, boxShadow: "0 25px 65px rgba(0,0,0,0.15)" }}
                  >
                    <div className="h-[52px] rounded-t-2xl flex justify-between items-center px-4" style={{ background: "linear-gradient(90deg,#7C3AED,#2563EB)" }}>
                      <div className="flex items-center gap-2">
                      ...
                      <div className="flex flex-col items-end">
                        ...
                        <div className="bg-white text-violet-700 font-black rounded-lg px-2 py-0.5 text-xs leading-none">93.1</div>
                      </div>
                    </div>
                    <div className="p-4 flex flex-col gap-3">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <div className="text-gray-400 text-xs mt-0.5">Providence Health</div>
                        </div>
                      ...
                      <div className="border-t border-gray-100 pt-2.5">
                        <div className="text-[9px] font-bold text-gray-300 uppercase tracking-widest mb-1.5">Data Match Sources</div>
                        <div className="flex gap-1.5">
                          {MATCH_SOURCES.map((s) => (
                            <div key={s.label} className="flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] font-bold" style={{ color: s.color, background: s.bg }}>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-violet-600 text-xs font-bold cursor-pointer hover:text-violet-700">View Profile →</span>
                      </div>
                    </div>
                  </div>
                ...
                <div
                  className="relative z-10 mt-8 mx-auto rounded-2xl border border-gray-100 bg-white overflow-hidden"
                  style={{ width: "370px", boxShadow: "0 8px 32px rgba(0,0,0,0.08)" }}
                >
                  <div className="flex items-center justify-between px-4 py-2.5" style={{ background: "linear-gradient(90deg,#7C3AED,#2563EB)" }}>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="px-4 py-3 flex flex-col gap-2">
                    <div className="flex items-end gap-1 h-10">
                      <div className="flex items-center gap-1 text-[9px] font-bold text-violet-400 uppercase tracking-widest mr-1 flex-shrink-0">
                        <Mic className="w-2.5 h-2.5" /> Officer
                      </div>
                      <div className="flex items-end gap-[2px] flex-1">
                        {WAVEFORM.map((h, i) => (
                          <div key={i} className="rounded-full flex-1" style={{
                            ...
                            animation: `prysmWave ${0.8 + (i % 5) * 0.15}s ease-in-out infinite alternate`,
                    ...
                    <div className="flex items-end gap-1 h-10">
                      <div className="flex items-center gap-1 text-[9px] font-bold text-cyan-400 uppercase tracking-widest mr-1 flex-shrink-0">
                        <Mic className="w-2.5 h-2.5" /> Prospect
                      </div>
                      <div className="flex items-end gap-[2px] flex-1">
                        {[...WAVEFORM].reverse().map((h, i) => (
                          <div key={i} className="rounded-full flex-1" style={{
                            ...
                            animation: `prysmWave ${0.7 + (i % 4) * 0.18}s ease-in-out infinite alternate`,
                  ...
                  <div className="px-4 py-2 border-t border-gray-50 bg-gray-50 flex items-center justify-between">
                    <span className="text-[10px] font-semibold text-gray-400">Context: Cardiac ICU stay · Dr. Martinez referral</span>
                ...
                <div className="flex flex-wrap justify-center gap-2.5 mt-5 z-10 relative">
                  <div className="flex items-center gap-1.5 bg-white shadow-sm border border-gray-100 rounded-full px-3 py-1.5 text-xs font-semibold text-gray-600">
