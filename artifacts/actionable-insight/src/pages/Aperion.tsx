  ...
  return (
    <div className="overflow-hidden bg-white">
            ...
            <div className="flex-1 max-w-[560px]">
              ...
              <AnimatedSection delay={0.14}>
                <p className="text-gray-500 text-lg leading-relaxed mb-9">
                  Aperion eliminates 75% of administrative burden — replacing it
                  with AI-prepared donor briefings, intelligent opportunity
                  matching, and proposal intelligence that makes every
                  conversation count.
                </p>
                <p className="text-gray-400 text-sm leading-relaxed mb-9">
                  Built for Blackbaud CRM and Salesforce NPSP. Works inside the
                  tools your team already uses. No new dashboard. No training
                  curve.
                </p>
              </AnimatedSection>
              ...
              <AnimatedSection delay={0.18}>
                <div className="flex flex-wrap gap-3 mb-10">
                  ...
                  <button
                    className="flex items-center gap-2 px-8 py-4 rounded-xl border-2 font-bold text-[15px] text-[#0A0E1A] hover:bg-gray-50 transition-colors"
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #04081E 0%, #080F2E 60%, #060D28 100%)",
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection>
              ...
              <p className="text-slate-400 text-lg leading-relaxed mb-5">
                The average gift officer spends 75% of their time on research,
                data entry, proposal writing, and meeting prep — leaving only
                25% for actual donor relationships.
              </p>
              <p className="text-slate-400 text-lg leading-relaxed">
                Aperion inverts that ratio. It handles the preparation, the
                follow-up, and the paperwork — so your team can spend 75% of
                their time doing what only humans can do.
              </p>
            </AnimatedSection>
              ...
              >
                <div className="flex items-start gap-4 mb-8">
                  ...
                  <blockquote className="text-xl font-black text-white tracking-tight leading-snug uppercase">
                    "Every gift officer deserves to spend their time on
                  ...
                  {[
                    ...
                    >
                      <div className="flex items-center justify-center gap-2 mb-2">
                        <span className="text-xl font-black text-slate-600 line-through">
                          {row.before}
                        </span>
      ...
      <section
        ...
        style={{
          background: "linear-gradient(135deg,#04081E 0%,#060D28 100%)",
          borderColor: "rgba(255,255,255,0.08)",
        }}
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <AnimatedSection>
              <p className="text-xs font-bold text-cyan-400 uppercase tracking-widest mb-5">
                Built for Gift Officers
              </p>
              <blockquote
              ...
              <p className="text-white/55 text-lg leading-relaxed max-w-md">
                Aperion gives every gift officer the preparation, context, and
                follow-through of a full research team — without the overhead.
              </p>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.12}>
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to top, rgba(4,8,30,0.55) 0%, transparent 60%)",
                  }}
                />
              </div>
            </AnimatedSection>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <AnimatedSection className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="text-gray-500 text-lg leading-relaxed">
              Aperion sits between your CRM data and your gift officers —
              turning fragmented information into actionable intelligence before
              every meeting.
            </p>
          </AnimatedSection>
              ...
              {ENGINE_ITEMS.map((item, i) => (
                <g key={i}>
                  <circle
                    ...
                    cy={204 + i * 22}
                    r="2.5"
                    fill={i < 2 ? "#2563EB" : i < 4 ? "#0891B2" : "#06B6D4"}
                  />
                  <text
                    x="392"
                    y={208 + i * 22}
      ...
      <section className="py-20 lg:py-28 border-b border-gray-100 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <AnimatedSection className="mb-12 max-w-3xl">
            ...
            <p className="text-gray-500 text-lg leading-relaxed">
              Each Aperion module eliminates a specific category of
              administrative friction — together they transform how your team
              operates.
            </p>
          </AnimatedSection>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {CAPABILITIES.map((cap, i) => (
              ...
              >
                ...
                <h3 className="text-base font-bold text-[#0A0E1A] uppercase tracking-tight mb-3">
                  {cap.title}
                </h3>
                ...
                <div
                  className="mt-6 pt-6 border-t border-gray-100 flex items-center gap-2 text-xs font-bold uppercase tracking-wider"
            ...
            <AnimatedSection
              delay={0.35}
              className="bg-[#0A0E1A] rounded-2xl p-8 flex flex-col"
            >
              <p className="text-xs font-bold text-cyan-400 uppercase tracking-widest mb-5">
                Net Result
              </p>
              ...
              <p className="text-white/55 text-sm leading-relaxed flex-1">
                ROI by year two, for every dollar invested in Aperion.
              </p>
              <div className="mt-6 pt-6 border-t border-white/10 text-xs font-bold text-white/25 uppercase tracking-widest">
                Measured outcome
              </div>
            </AnimatedSection>
          </div>
            ...
            {[
              {
                ...
                desc: "Gift officers reclaim the majority of their week for relationship-building.",
              },
              {
                stat: "3×",
                label: "Meaningful Touchpoints",
                desc: "Aperion users average 3× more high-quality donor interactions per month.",
              },
              {
                stat: "300+",
                label: "Opportunity Library",
                desc: "Pre-built funding opportunities matched intelligently to each donor's interests.",
              },
              {
                stat: "20:1",
                label: "ROI by Year Two",
                desc: "For every dollar invested in Aperion, programs return twenty in philanthropic revenue.",
              },
            ].map((item, i) => (
              <AnimatedSection
                key={i}
              ...
              >
                ...
                <div className="text-sm font-bold text-[#0A0E1A] uppercase tracking-tight mb-3">
                  {item.label}
                </div>
      ...
      <section className="py-24 lg:py-32 bg-[#0A0E1A] text-white relative overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 50%, rgba(6,182,212,0.08) 0%, transparent 65%)",
          }}
        />
        <div className="max-w-2xl mx-auto px-6 text-center relative z-10">
          <AnimatedSection>
            ...
            <p className="text-white/45 text-lg leading-relaxed mb-10">
              See how Aperion works inside your existing Blackbaud or Salesforce
              environment — no new interface, no training curve.
            </p>
