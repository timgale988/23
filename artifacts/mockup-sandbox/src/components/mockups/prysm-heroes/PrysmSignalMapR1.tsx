...
export function PrysmSignalMapR1() {
  return (
    <section
        ...
        >
          ...
          <div className="relative w-full z-10" style={{ height: "480px" }}>
            <svg viewBox="0 0 580 480" className="w-full h-full overflow-visible">
              ...
              {/* Outer orbit rings */}
              <circle cx="290" cy="225" r="148" fill="none" stroke="#AAAAAA" strokeWidth="0.75" strokeDasharray="5 9" opacity="0.5" />
              <circle cx="290" cy="225" r="110" fill="none" stroke="#BBBBBB" strokeWidth="0.5" strokeDasharray="3 7" opacity="0.4" />
