...
export function PrysmSignalMapR2() {
  return (
    <section
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-8">
            <div className="flex items-center gap-1.5">
              ...
              <div className="h-px w-5" style={{ background: "#111111" }} />
            </div>
            <span
        ...
        <div
          ...
          style={{ background: "linear-gradient(135deg, #F7F4FF 0%, #EDEAFA 60%, #E8E8F2 100%)" }}
        >
          {/* Subtle grid */}
          <div
          ...
          <div className="relative w-full z-10" style={{ height: "480px" }}>
            <svg viewBox="0 0 580 480" className="w-full h-full overflow-visible">
              ...
              {/* CENTRAL HUB */}
              <circle cx="290" cy="225" r="90" fill="rgba(124,58,237,0.07)" />
              <circle cx="290" cy="225" r="84" fill="none" stroke="#7C3AED" strokeWidth="1.5" opacity="0.25" />
              <circle cx="290" cy="225" r="78" fill="url(#hubGrad)" filter="url(#smShadowMono)" />
              ...
              <text x="290" y="238" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="10" fontWeight="600" letterSpacing="2.5" fontFamily="Urbanist, sans-serif">AI ENGINE</text>
              ...
              {[
                ...
                <g key={label} transform={`translate(8, ${y})`} filter="url(#smShadowMono)">
                  ...
                  <rect x="0" y="0" width="3" height="44" rx="1.5" fill="#7C3AED" />
